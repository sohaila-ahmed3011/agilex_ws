...
get_filename_component(_filename "/home/ros/agile_x/src/behavior_selector/srv/MissionModeChange.srv" NAME_WE)
add_custom_target(_behavior_selector_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "behavior_selector" "/home/ros/agile_x/src/behavior_selector/srv/MissionModeChange.srv" ""
)
...
_generate_srv_cpp(behavior_selector
  "/home/ros/agile_x/src/behavior_selector/srv/MissionModeChange.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/behavior_selector)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/behavior_selector\")")
  # install generated code
  install(
